...
const PropertyDetail = () => {
  ...
  return (
    <>
            <Helmet>
        <title>{prop ? `${prop.title} - RealtyTopper` : 'Property Details - RealtyTopper'}</title>
        <meta name="description" content={prop ? `${prop.title} for sale in ${prop.location}` : 'Property details on RealtyTopper'} />
      </Helmet>
