                      ...
                      <div className="flex items-start space-x-4">
                        ...
                        <img
                          src={(() => {
                            ...
                            return mediaUrlsArray?.[0] ? (import.meta.env.PROD ? `${window.location.origin}${mediaUrlsArray[0]}` : `${import.meta.env.VITE_API_URL || 'http://localhost:3001'}${mediaUrlsArray[0]}`) : '/placeholder-property.svg'
                          })()}
