                          ...
                          <div className="flex space-x-2">
                            ...
                            <button
                              onClick={() => {
                                ...
                                img.src = user.aadhaarImage?.startsWith('/uploads/') ? `${import.meta.env.PROD ? window.location.origin : (import.meta.env.VITE_API_URL || 'http://localhost:3001')}${user.aadhaarImage}` : user.aadhaarImage || ''
