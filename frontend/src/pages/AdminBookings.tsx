                  ...
                  {selectedBooking.paymentProof ? (
                    <div className="space-y-2">
                      <div className="bg-yellow-50 p-3 rounded-lg border border-yellow-200">
                        ...
                        <a 
                                                      href={import.meta.env.PROD ? `${window.location.origin}${selectedBooking.paymentProof}` : `${import.meta.env.VITE_API_URL || 'http://localhost:3001'}${selectedBooking.paymentProof}`}
                          target="_blank"
