...
const DealerSignup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(
        "Dealer registration submitted successfully! Awaiting admin approval. You can sign in as a regular user while waiting."
      );
      navigate("/login");
    } catch (error: any) {
          ...
          <div className="card">
            <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                {formData.password && (
                  <div className="mt-2">
                    ...
                    <div className="text-xs text-gray-500 mt-1">
                      Must contain: 8+ chars, lowercase, uppercase, number,
                      special char
                    </div>
                  </div>
                )}
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  If you were referred by an existing dealer, enter their
                  referral code here. Leave empty to join directly under the
                  company.
                </p>
              </div>
