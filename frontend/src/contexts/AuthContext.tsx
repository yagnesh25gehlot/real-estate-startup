...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (userData) {
      try {
        ...
        console.log(
          "🔍 AuthContext useEffect - setting user from localStorage:",
          parsedUser
        );
        setUser(parsedUser);
  ...
  const login = async (userData: User) => {
    try {
      ...
      console.log(
        "🔍 localStorage before setUser - user:",
      ...
      console.log(
        "🔍 localStorage after setUser - user:",
        !!localStorage.getItem("user")
      );
      ...
      console.log(
        "🔍 localStorage after navigation - user:",
        !!localStorage.getItem("user")
      );
    } catch (error: any) {
  ...
  const refreshAuth = () => {
    ...
    if (userData) {
      try {
        const parsedUser = JSON.parse(userData);
        console.log(
          "🔍 refreshAuth - setting user from localStorage:",
          parsedUser
        );
        setUser(parsedUser);
